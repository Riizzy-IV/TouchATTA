...
const TOP_TABS = [
  ...
  // 'fachada-interativa' e 'orientacao-solar' removidas temporariamente a pedido do cliente
            ...
            {AREAS.map(area => (
              ...
              >
                <img
                  ...
                  alt={area.label}
                  className={styles.areasCardImg}
                  draggable={false}
                />
                <div className={styles.areasCardOverlay} />
                <span className={styles.areasCardLabel}>{area.label}</span>
              </button>
            ))}
          </div>
