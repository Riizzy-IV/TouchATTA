...
const UNITS = [
  { id: 'unidade-11',                 name: 'UNIDADE 11',                     area: '44,30 m²', img: '/img/plantas-humanizadas/unidade-11.webp' },
  { id: 'unidades-12-17',             name: 'UND. 12 A 17',                   area: '34,97 m²', img: '/img/plantas-humanizadas/unidades-12-17.webp' },
  { id: 'unidade-18',                 name: 'UNIDADE 18',                     area: '40,40 m²', img: '/img/plantas-humanizadas/unidade-18.webp' },
  { id: 'unidades-21-31',             name: 'UND. 21/31',                     area: '44,30 m²', img: '/img/plantas-humanizadas/unidades-21-31.webp' },
  { id: 'unidades-22-27-32-37',       name: 'UND. 22,27,32,37',               area: '34,97 m²', img: '/img/plantas-humanizadas/unidades-22-27-32-37.webp' },
  { id: 'unidades-28-38',             name: 'UND. 28/38',                     area: '40,40 m²', img: '/img/plantas-humanizadas/unidades-28-38.webp' },
  { id: 'unidade-41',                 name: 'UNIDADE 41',                     area: '49,90 m²', img: '/img/plantas-humanizadas/unidade-41.webp' },
  { id: 'unidades-51-61-71-81-91',    name: 'UND. 51,61,71,81,91',            area: '49,90 m²', img: '/img/plantas-humanizadas/unidades-51-61-71-81-91.webp' },
  { id: 'unidades-52-62-72-82-92',    name: 'UND. 52,62,72,82,92',            area: '38,96 m²', img: '/img/plantas-humanizadas/unidades-52-62-72-82-92.webp' },
  { id: 'unidades-53-63-73-83-93',    name: 'UND. 53,63,73,83,93',            area: '44,74 m²', img: '/img/plantas-humanizadas/unidades-53-63-73-83-93.webp' },
];
        ...
        <div className={styles.instructions}>
          <div className={styles.instrItem}>
            <svg className={styles.instrIcon} viewBox="0 0 40 40" fill="none">
              <path d="M20 6L20 34M6 20L34 20" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round"/>
              <path d="M20 6L17 11M20 6L23 11" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M20 34L17 29M20 34L23 29" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M6 20L11 17M6 20L11 23" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M34 20L29 17M34 20L29 23" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <span className={styles.instrText}>ARRASTE PARA MOVER</span>
          </div>
          <div className={styles.instrItem}>
            <svg className={styles.instrIcon} viewBox="0 0 40 40" fill="none">
              <path d="M8 8L16 8M8 8L8 16" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M32 8L24 8M32 8L32 16" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M8 32L16 32M8 32L8 24" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M32 32L24 32M32 32L32 24" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <circle cx="20" cy="20" r="4" stroke="rgba(201,168,76,0.7)" strokeWidth="1.5"/>
            </svg>
          ...
          <div className={styles.instrItem}>
            <svg className={styles.instrIcon} viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="7" r="2.5" stroke="rgba(201,168,76,0.6)" strokeWidth="1"/>
              <circle cx="12" cy="7" r="4.5" stroke="rgba(201,168,76,0.3)" strokeWidth="0.8"/>
              <path d="M8.5 12.5 L8.5 8 C8.5 7.2 9.2 6.5 10 6.5 C10.8 6.5 11.5 7.2 11.5 8 L11.5 11 C11.8 10.7 12.3 10.5 12.8 10.5 C13.4 10.5 13.9 10.9 14 11.4 C14.3 11.1 14.7 11 15.1 11.1 C15.6 11.3 15.8 11.7 15.9 12.1 C16.2 11.9 16.6 11.9 17 12.2 C17.4 12.5 17.5 13 17.5 13.5 L17.5 16 C17.5 18 16 19.5 14 19.5 L12 19.5 C10.5 19.5 9.2 18.6 8.7 17.3 L7.3 14.3 C7 13.6 7.4 12.8 8.1 12.6 L8.5 12.5Z"
                stroke="rgba(201,168,76,0.8)" strokeWidth="1.1" strokeLinejoin="round"/>
            </svg>
